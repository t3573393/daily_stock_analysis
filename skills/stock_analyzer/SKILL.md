...
| **热点板块** | `/hot` 或 `/hot --days=30` | 追踪最近30日热点板块涨跌热度 |
...
| 排名 | 板块名称 | 涨跌幅 | 换手率 | 热度指数 | 趋势 |
|------|---------|-------|--------|---------|------|
| 1 | 新能源汽车 | +4.52% | 8.23% | 95.2 | 📈 |
| 2 | 半导体 | +3.87% | 6.45% | 88.5 | 📈 |
| 3 | AI芯片 | +3.21% | 7.12% | 82.3 | 📈 |
...
